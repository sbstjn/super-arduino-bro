...
// class
//-----------------------------------------------------------------------------
class ColorduinoObject : public ColorTools {
protected:
	//-----------------------------------------------------------------------------
	// methods
	//-----------------------------------------------------------------------------
...
public:
	...
	// properties
	//-----------------------------------------------------------------------------
	ColorRGB frameBuffer0[ColorduinoScreenWidth*ColorduinoScreenHeight];
	ColorRGB frameBuffer1[ColorduinoScreenWidth*ColorduinoScreenHeight];

	ColorRGB *curDrawFrame;
	ColorRGB *curWriteFrame;
	...
	// gets
	//-----------------------------------------------------------------------------
	ColorRGB *GetPixel(unsigned char x,unsigned char y) {
	...
	//-----------------------------------------------------------------------------
	ColorRGB *GetDrawPixel(unsigned char x,unsigned char y) {
